...
game:GetService("RunService").Heartbeat:Connect(function()
    if dispear.CamlockState and TargetPlayer and TargetPlayer.Character and TargetPlayer.Character:FindFirstChild("HumanoidRootPart") then
        local targetPosition = TargetPlayer.Character.HumanoidRootPart.Position
        if dispear.AutoPredState then
            targetPosition = targetPosition + (TargetPlayer.Character.HumanoidRootPart.Velocity * dispear.Prediction)
        end
...
local function UpdatePredictionBasedOnPing()
    ...
    if ping > 225 then
        getgenv().dispear.Prediction = 0.166547
    elseif ping > 215 then
        getgenv().dispear.Prediction = 0.15692
    elseif ping > 205 then
        getgenv().dispear.Prediction = 0.165732
    elseif ping > 190 then
        getgenv().dispear.Prediction = 0.169
    elseif ping > 185 then
        getgenv().dispear.Prediction = 0.1235666
    elseif ping > 180 then
        getgenv().dispear.Prediction = 0.16779123
    elseif ping > 175 then
        getgenv().dispear.Prediction = 0.165455312399999
    elseif ping > 170 then
        getgenv().dispear.Prediction = 0.16
    elseif ping > 165 then
        getgenv().dispear.Prediction = 0.15
    elseif ping > 160 then
        getgenv().dispear.Prediction = 0.1223333
    elseif ping > 155 then
        getgenv().dispear.Prediction = 0.125333
    elseif ping > 150 then
        getgenv().dispear.Prediction = 0.1652131
    elseif ping > 145 then
        getgenv().dispeae.Prediction = 0.129934
    elseif ping > 140 then
        getgenv().dispear.Prediction = 0.1659921
    elseif ping > 135 then
        getgenv().dispear.Prediction = 0.1659921
    elseif ping > 130 then
        getgenv().dispear.Prediction = 0.12399
    elseif ping > 125 then
        getgenv().dispear.Prediction = 0.15610
    elseif ping > 110 then
        getgenv().dispear.Prediction = 0.16782
    elseif ping > 105 then
        getgenv().dispear.Prediction = 0.1208090
    elseif ping > 100 then
        getgenv().dispear.Prediction = 0.130340
    elseif ping > 90 then
        getgenv().dispear.Prediction = 0.1433333333392
    elseif ping > 80 then
        getgenv().dispear.Prediction = 0.143214443
    elseif ping > 70 then
        getgenv().wzmh.Prediction = 0.14899911
    elseif ping > 60 then
        getgenv().dispear.Prediction = 0.148325
    elseif ping > 50 then
        getgenv().dispear.Prediction = 0.128643
    elseif ping > 40 then
        getgenv().dispear.Prediction = 0.12766
    elseif ping > 30 then
        getgenv().dispear.Prediction = 0.124123
    elseif ping > 20 then
        getgenv().wzmh.Prediction = 0.12435
    elseif ping > 10 then
        getgenv().dispear.Prediction = 0.1234555
    else
        getgenv().dispear.Prediction = 0.1332
    end
end
...
CamlockButton.MouseButton1Click:Connect(function()
    getgenv().dispear.CamlockState = not getgenv().dispear.CamlockState
    enemy = getgenv().dispear.CamlockState and FindNearestEnemy() or nil
end)
